...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('verifica input telefone somente númerico', function() {
        cy.get('#firstName').type('Andre', {delay: 0})
        cy.get('#lastName').type('Cassaniga', {delay: 0})
        cy.get('#email').type('andrecassaniga.mailinator.com', {delay: 0})
        cy.get('#phone')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        cy.get('#firstName')
          ...
          .should('have.value', '')
        cy.get('#lastName')
          .type('Cassaniga', {delay: 0})
          .should('have.value', 'Cassaniga')
          .clear()
          .should('have.value', '')
        cy.get('#email')
          .type('andrecassaniga.mailinator.com', {delay: 0})
          .should('have.value', 'andrecassaniga.mailinator.com')
          .clear()
          .should('have.value', '')
        cy.get('#phone')
          .type('999998888')
